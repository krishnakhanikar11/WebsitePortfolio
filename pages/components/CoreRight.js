...
function CoreRight({title,desc,src,link,linkExt,tool1,tool2,tool3,tool4}) {
    return (
      <Fade Top delay={500}>
        <div className='flex pt-4 md:pb-28 pb-0'>
         <div className='flex flex-col w-full md:w-[55%] z-10'>
            <div className='bg-green-tint rounded-sm shadow-inner md:shadow-none md:bg-transparent p-4 md:p-0'>
               ...
               <div className='flex md:pb-5 md:pt-5 pb-1 pt-2 tracking-tight font-greenText  text-sm md:text-sm text-slate space-x-5'>
                  <p>{tool1}</p>
                  <p>{tool2}</p>
                  <p>{tool3}</p>
                  <p>{tool4}</p>
               </div>
               <div className='flex space-x-5 pt-2 md:pt-0'>
                  <div>
                     <a href={link}>
                        <svg
